...
## Career
* 🏦 신한은행 ICT | 정규직 |  
  * 2021.07.19 ~ | Big Data Platform | Hadoop ETL, 외부데이터 수집, 배치 자동화 | React, Spring | Cloudera CDH/CDP | HDFS, MapReduce | Yarn, Zookeeper | Impala, Hive | Spark, Spark Streaming | Kudu | Kafka | NiFi | Oozie
