...
## Career 
* 🏦 카카오뱅크 | 정규직 |  
  * 2022.06.07 ~ | 여신뱅킹API개발 (Loan Banking API Development) | 전자금융 (Electronic Finance) | Card/Loan Banking Service | ARS, Mobile Channel | Credit Card Service | Class Diagram, ERD - StarUML | APM Monitoring - Jeniffer | JVM Monitoring - VisualVM | 
